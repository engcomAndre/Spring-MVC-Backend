...
INSERT INTO `categoria` VALUES (1,'Informática'),(2,'Escritório'),(3,'Cama mesa banho '),(4,'Eletronicos'),(5,'Jardinagem'),(6,'Perfumaria'),(7,'Decoração'),(8,'Informática'),(9,'Escritório'),(10,'Cama mesa banho '),(11,'Eletronicos'),(12,'Jardinagem'),(13,'Perfumaria'),(14,'Decoração');
...
INSERT INTO `cidade` VALUES (1,'Uberlandia',1),(2,'São Paulo',2),(3,'Campinas',2),(4,'Uberlandia',3),(5,'São Paulo',4),(6,'Campinas',4);
...
INSERT INTO `cliente` VALUES (1,'12345678911','maria@gmail.com','Maria da Silva',1);
...
INSERT INTO `endereco` VALUES (1,'Jardim','61604555','Apto303','Rua Flores...','300',1,1),(2,'Centro','61600555','Sala 500','Rua Aveida...','31',2,1);
...
INSERT INTO `item_pedido` VALUES (0,2000,1,1,1),(0,80,2,1,2),(100,800,1,2,2);
...
INSERT INTO `pedido` VALUES (1,'2017-09-30 10:30:00',1,1),(2,'2017-10-10 19:35:00',1,2);
...
INSERT INTO `produto` VALUES (1,'Computador',2000),(2,'Impressora',800),(3,'Mouse',80),(4,'Mesa de Escritório',300),(5,'Toalha',50),(6,'Colcha',200),(7,'TV true color',1200),(8,'Roçadeira',800),(9,'Abajour',100),(10,'Pendente',80),(11,'Shampoo',90),(12,'Computador',2000),(13,'Impressora',800),(14,'Mouse',80),(15,'Mesa de Escritório',300),(16,'Toalha',50),(17,'Colcha',200),(18,'TV true color',1200),(19,'Roçadeira',800),(20,'Abajour',100),(21,'Pendente',80),(22,'Shampoo',90);
...
CREATE TABLE `produto_categoria` (
  `produto_id` int(11) NOT NULL,
  `cateforia_id` int(11) NOT NULL,
  KEY `FKr74r1mgtvc8ndslab5r8ysw9u` (`cateforia_id`),
  ...
  CONSTRAINT `FKr74r1mgtvc8ndslab5r8ysw9u` FOREIGN KEY (`cateforia_id`) REFERENCES `categoria` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `produto_categoria` VALUES (1,1),(1,4),(2,1),(2,2),(2,4),(3,1),(3,4),(4,2),(5,3),(6,3),(7,4),(8,5),(9,6),(10,6),(11,7),(12,8),(12,11),(13,8),(13,9),(13,11),(14,8),(14,11),(15,9),(16,10),(17,10),(18,11),(19,12),(20,13),(21,13),(22,14);
...
INSERT INTO `telefone` VALUES (1,'1234568900'),(1,'142536789');
...
-- Dump completed on 2018-06-26 10:45:50
